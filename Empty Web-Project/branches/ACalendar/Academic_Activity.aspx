<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Academic_Activity.aspx.cs" EnableTheming="true"
                    ...
                    <td>
                        <table class="style1" style="table-layout: fixed">
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlActivitytype" runat="server" Width="200px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:TextBox ID="subActivity" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                ...
                <tr>
                    <td>
                        <cc2:GroupedGridView ID="gvActivity" runat="server" AutoGenerateColumns="False" 
                            CellPadding="0" CssClass="mGrid" GroupedDepth="2" Width="100%">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sub Activity">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("SubActivity") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="LNKSubActivity" runat="server" 
                                            onclick="LNKSubActivity_Click" Text='<%# Bind("SubActivity") %>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Activity_ID" Visible="False">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("ActivityID") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
