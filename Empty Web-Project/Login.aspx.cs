                ...
                else
                {
                    ...
                    if (temp == 1)
                    {
                        ...
                        if (passw == Pass.Text)
                        {
                            ...
                            if(DropDownList1.SelectedItem.Equals("student"))
                                Response.Redirect("student_dashboard.aspx?id=" + log.Text.ToString() + "");
                            else
                                Response.Redirect("resultpublish.aspx?id=" + log.Text.ToString() + "");
                        }
                        else
