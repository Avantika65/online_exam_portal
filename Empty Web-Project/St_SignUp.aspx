<%@ Page Language="C#" AutoEventWireup="true" CodeFile="St_SignUp.aspx.cs" Inherits="St_SignUp" %>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="margin-top:25%;background-color:rgba(223,202,203,1)">
        ...
        <div style="margin-top:6%">
            <h2 style="text-align:center;font-family:'Times New Roman'">Student Registration Form</h2>
        </div>
<div class="di">
  <div class="row">
    ...
    <div class="row">
              <div class="col-sm-4 col-md-4"><p style="font-family:Times New Roman;"><b>Father's Name :</b></p></div>
              <div class="col-sm-5 col-md-5"><asp:TextBox ID="FaTextBox" runat="server"></asp:TextBox></div>
        <div class="col-sm-2 col-md-2">
                      <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="Enter a valid Father's Name" ControlToValidate="FaTextBox" ForeColor="#FF3300" ValidationExpression="^[a-zA-Z''-'\s]{1,40}$"></asp:RegularExpressionValidator>
    ...
    <div class="row">
              <div class="col-sm-4 col-md-4"><p style="font-family:Times New Roman;"><b>Roll number :</b></p></div>
              <div class="col-sm-4 col-md-4">
                  <asp:TextBox ID="RoTextBox" runat="server" Width="60%"></asp:TextBox></div>
              </div>
     <div class="row">
