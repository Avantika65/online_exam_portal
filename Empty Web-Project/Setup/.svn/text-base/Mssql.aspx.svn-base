...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div id="divSetup" runat="server">
        ...
        <div class="block">
            ...
            <asp:LinkButton ID="btnMssqlGoBack" CssClass="linkbutton" runat="server" 
                onclick="btnMssqlGoBack_Click"><%=Language.Setup["GoBack"] %></asp:LinkButton>
        </div>
    </div>
</asp:Content>
