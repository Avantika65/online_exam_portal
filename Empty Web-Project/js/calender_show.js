...
function get_holiday_value(result) {
    ...
    Calender_details.todo_details_show(new_year + "/" + new_month + "/" + dis_value1, get_holiday_value1);
}
...
function check_value(subjectid, instituteid, sessionid, empid, courseid, semid, value) {
   
    var mypoup = document.getElementById('event_popup1');
    mypoup.style.top = "5%";
    mypoup.style.left = "25%";
    mypoup.style.display = "block";
    Calender_details.get_Student_attendance_details_show(subjectid, instituteid, sessionid, empid, courseid, semid,value, Get_Details_popup);
}
