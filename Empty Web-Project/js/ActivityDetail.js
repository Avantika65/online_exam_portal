...
window.onload = bind_month_value1;
...
function lnk() {
    ...
    var lnk = document.getElementById("Span5");
    var divgrd = document.getElementById("divgrd");
    var grd = document.getElementById("GridView1");

    if (lnk.innerText == 'Calender View') {

        divgrd.style.display = "none";
        Calender1.style.display = "block";
        calender.style.display = "block";
        lnk.innerText = "List View";
    }
    else {

        Calender1.style.display = "none";
        calender.style.display = "none";
        divgrd.style.display = "block";


        lnk.innerText = "Calender View";
    }

    Calender_details.Activity_detail('2015', getdata1);
    ...
    for (j = 0; j < 42; j++) {
        ...
        if (j < firstDay) {
            ...
            for (var l = 0; l < day_name.length; l++) {
                ...
                else if (displayNum == day_name[l] && month1 == monthname[l] && leavename[l] != "SUNDAY") {
...
function next_click() {
    ...
    Calender_details.Activity_detail('2015', getdata);
