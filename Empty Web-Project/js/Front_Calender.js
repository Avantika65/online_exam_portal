...
function lnk() {
    ...
    var divgd = document.getElementById("divgrd");



    if (lnk.innerText == 'View Calender') {

        divgd.style.display = "none";
        Calender1.style.display = "block";
        calender.style.display = "block";
        lnk.innerText = "View List";
    }
    else {

        Calender1.style.display = "none";
        calender.style.display = "none";
        divgd.style.display = "block";


        lnk.innerText = "View Calender";
    }

    Calender_details.hodiday_detail('2015', getdata1);
