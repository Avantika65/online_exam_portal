...
public partial class St_SignUp : System.Web.UI.Page
{static String passwords;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                Dbranch.Items.Insert(0, "---Select Branch---");
            ...
            if (IsPostBack)
            {
                ...
                conn.Open();
                string checkUser = "select count(*) from student_detail where email='" + TextBox_EmailId.Text + "'";
    ...
    protected void Course_SelectedIndexChanged(object sender, EventArgs e)
    {
       // try
        ...
        if (Dcourse.SelectedItem.ToString() == "B.tech")
        {
            ...
            objFunc.FillDropdownlist(Dbranch, "Branch", "Id", sql, "---Select Branch---");
        }
        else
        {
            BranchDiv.Visible = false;
       ...
       // {
            ...
            string ext = Path.GetExtension(filename);
                if ((Dcourse.SelectedItem.ToString()).Equals("---Select Course---"))
                {
                    ...
                    if ((Dcourse.SelectedItem.ToString()).Equals("B.tech") && (Dbranch.SelectedItem.ToString()).Equals("---Select Branch---"))
                    {
                        BranchDiv.Visible = true;
                    }
                    else
    ...
    protected void Button_OTP1_Submit(object sender, EventArgs e)
    {
        ...
        //{
            ...
            if (TextBox_OTP1.Text == otp)
            {
                ...
                string filename = Path.GetFileName(filePath);
                string ext = Path.GetExtension(filename);
                DateTime date = Convert.ToDateTime(TextBox1.Text.ToString());
                int student_id=Convert.ToInt32(TextBox_CollegeId.Text);
                ...
                {
                    if ((Dbranch.SelectedItem.ToString()).Equals("---Select Branch---"))
                    {

                        String sql = "INSERT INTO student_detail (course,Subject,s_name,dob,email,student_id,Password,m_no,gender,img,fa_name,roll_no) VALUES ('" + Dcourse.SelectedItem + "','" + Dsubject.SelectedItem + "','" + TextBox_FirstName.Text + " " + TextBox_LastName.Text + "','" + date + "','" + TextBox_EmailId.Text + "','" + TextBox_CollegeId.Text + "','" + passwords + "','" + TextBox_MobileNumber.Text + "','" + gender + "',@asd,'" + FaTextBox.Text + "','" + RoTextBox.Text + "') ";
                    ...
                    {
                        String sql = "INSERT INTO student_detail (Course,branch,Subject,s_name,dob,email,student_id,Password,m_no,gender,img,fa_name,roll_no) VALUES ('" + Dcourse.SelectedItem + "','" + Dbranch.SelectedItem + "','" + Dsubject.SelectedItem + "','" + TextBox_FirstName.Text + " " + TextBox_LastName.Text + "','" + date + "','" + TextBox_EmailId.Text + "','" + student_id + "','" + passwords + "','" + TextBox_MobileNumber.Text + "','" + gender + "',@asd,'" + FaTextBox.Text + "','" + RoTextBox.Text + "') ";
                        SqlCommand cmd1 = new SqlCommand(sql, conn);
                        cmd1.Parameters.AddWithValue("@asd", file);
                        cmd1.ExecuteNonQuery();
                        Response.Redirect("Login.aspx");
   ...
   /* protected void Dbranch_SelectedIndexChanged1(object sender, EventArgs e)
    ...
    /*protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["FeesManagementConn"].ConnectionString);
        conn.Open();
        String sql = "INSERT INTO student_detail values(@asd)";
