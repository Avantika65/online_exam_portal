		...
		if ($.cookie('gritter_show')) {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Welcome to ESIM Campus!',
                    // (string | mandatory) the text inside the notification
                    text: 'ESIM is a feature-rich ERP package to improve your productivity!',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    // (string | mandatory) the heading of the notification
                    title: 'Customize ESIM!',
                    // (string | mandatory) the text inside the notification
                    text: 'ESIM ERP is easily customizable, lightweight and has a great User Experience.',
                    // (string | optional) the image to display on the left
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    title: 'Get started!',
                    // (string | mandatory) the text inside the notification
                    text: 'Get started with ESIM ERP and see how your productivity increases!',
                    // (string | optional) the image to display on the left
