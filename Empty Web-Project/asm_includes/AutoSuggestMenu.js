...
{	//debugger;
    ...
    self.OnSelectedValueEvent=null;     //Overridable event handler that is called after textbox is updated with suggestion
            
    //DB Variables            
    self.useFlexibleQuery=false;
    self._TableTextField=null;
    self._TableValueField=null;
    self._TableName=null;
    self._TableCondition=null;
    //Internal attributes
    var _dom=null;  	
...
// ANil       iFrame.style.visibility="hidden";
	...
	{//debugger;
	    ...
	    //debugger;
	    var func=(self.useFlexibleQuery==true?self.onGetMenuItems + "(\"" + value + "\", " + 
	                                                    self.usePaging + ", " +
	                                                    _pageIndex + ", " + 
	                                                    self.pageSize + ", " +
	                                                    self.useFlexibleQuery + ", \"" +
	                                                    self._TableName + "\", \"" +
	                                                    self._TableTextField+ "\", \"" +
	                                                    self._TableValueField + "\", \"" +
	                                                    self._TableCondition + "\", self.refreshMenuItemsCallback)"
	                                                    :	                                                    
	                                                    self.onGetMenuItems + "(\"" + value + "\", " + 
	                                                    self.usePaging + ", " +
	                                                    _pageIndex + ", " + 
...
//        _dom.style.width=XUtils.getWidth(textBox)+"px";
_dom.style.width=null;
  _dom.style.width=_dom.offsetWidth+"px";
    ...
    self.onMenuItemClick = function(itemIndex)
	{
		...
		if(self.OnSelectedValueEvent!=null && self.OnSelectedValueEvent!='')
				    {
				        var evt=new TextBoxUpdateEvent();
                        evt.source=self;
				        eval(self.OnSelectedValueEvent+"(evt);");}
