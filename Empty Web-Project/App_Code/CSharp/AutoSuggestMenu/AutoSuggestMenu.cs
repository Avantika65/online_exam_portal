...
namespace MSS
{
	...
	public class AutoSuggestMenu : WebControl, INamingContainer
	{
        ...
        private string _onSelectedValueEvent;

	    //Internal
        private HiddenField _hdnSelectedValue;
        
        //Database Field Variables
        private bool _useFlexibleQuery;
        private string _dbTableTextField;
        private string _dbTableValueField;
        private string _dbTableName;
        private string _dbTableCondition;
        ...
        public string OnSelectedValueEvent
        {
            get { return _onSelectedValueEvent; }
            set { _onSelectedValueEvent = value; }
        }
        ...
        //Database Table Lavel Properties
        public string TextField
        {
            get { return _dbTableTextField;}
            set { _dbTableTextField = value; }
        }
        public string ValueField
        {
            get { return _dbTableValueField; }
            set { _dbTableValueField = value; }
        }
        ...
        {
            get { return _dbTableCondition; }
            set { _dbTableCondition = value; }
        }
        public bool IsFlexibleQuery
        {
            get { return _useFlexibleQuery; }
            set { _useFlexibleQuery = value; }
        }
		#endregion
        ...
        public AutoSuggestMenu()
        {
            ...
            _useFlexibleQuery = false;

            _dbTableTextField = null;
            _dbTableValueField = null;
            _dbTableName = null;
            _dbTableCondition = null;
		...
		protected override void LoadViewState(object savedState) 
		{
            ...
            _onSelectedValueEvent       = (string)ViewState["OnSelectedValueEvent"];

            _useFlexibleQuery           = (bool)ViewState["FlexibleQuery"];            
            _dbTableTextField           = (string)ViewState["TableTextField"];
            _dbTableValueField          = (string)ViewState["TableValueField"];
            _dbTableName                = (string)ViewState["TableName"];
            _dbTableCondition           = (string)ViewState["TableCondition"];
		}
        ...
        protected override object SaveViewState()
        {
            ...
            ViewState["OnSelectedValueEvent"]   =   _onSelectedValueEvent;

            ViewState["FlexibleQuery"]          =   _useFlexibleQuery;
            ViewState["TableTextField"]         =   _dbTableTextField;
            ViewState["TableValueField"]        =   _dbTableValueField;
            ViewState["TableName"]              =   _dbTableName;
            ViewState["TableCondition"]         =   _dbTableCondition;
		...
		protected void WriteMenu()
		{
            ...
            writer.WriteLine("document.getElementById('" + this.NamingContainer.FindControl(_targetControlID).ClientID + "').className=document.getElementById('" + this.NamingContainer.FindControl(_targetControlID).ClientID + "').className+', asmSearchBox'");
            ...
            if(!String.IsNullOrEmpty(_onSelectedValueEvent))
                writer.WriteLine("menu.OnSelectedValueEvent=\"" + _onSelectedValueEvent + "\";");
            //----DB Variable Assignment
            writer.WriteLine("menu.useFlexibleQuery=" + _useFlexibleQuery.ToString().ToLower() + ";");
            writer.WriteLine("menu._TableTextField=\"" + _dbTableTextField + "\";");
            writer.WriteLine("menu._TableValueField=\"" + _dbTableValueField + "\";");
            writer.WriteLine("menu._TableName=\"" + _dbTableName + "\";");
            writer.WriteLine("menu._TableCondition=\"" + _dbTableCondition + "\";");
            //------------------------------------------------------------
        ...
        protected void CheckRequiredProperties()
        {
            ...
            if (_useFlexibleQuery)
            {
                if (String.IsNullOrEmpty(_dbTableName))
                    throw new Exception("TableName property is required.");
                if (String.IsNullOrEmpty(_dbTableTextField)) 
                    throw new Exception("TableTextField property is required.");
                if (String.IsNullOrEmpty(_dbTableValueField))
                    throw new Exception("TableValueField property is required.");
                //if (String.IsNullOrEmpty(_dbTableCondition))
                //    throw new Exception("TableCondition propery is required.");
            }
        }
